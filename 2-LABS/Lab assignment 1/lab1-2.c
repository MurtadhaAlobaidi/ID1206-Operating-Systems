...
int sender_process(struct mq_attr attributes, mqd_t mqd, char *my_mq) {
  ...
  FILE *fp = fopen("/Users/murtadha/Library/Mobile "
                   "Documents/com~apple~CloudDocs/Murtadha/SKOLAN/KTH2020 "
                   "Ingenjör /KTH Högskoleingenjörsdatateknik, "
                   "Kista/GitMurtadha/ID1206-Operating-Systems/2-LABS/Lab "
                   "assignment 1/lab1-2.c",
                   "r");
